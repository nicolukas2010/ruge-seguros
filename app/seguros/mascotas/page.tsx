...
import { PawPrint, Shield, CheckCircle2, ArrowLeft } from "lucide-react"

export const metadata: Metadata = {
  title: "Seguro de Mascotas | Ruge Seguros",
...
const requisitos = [
  ...
  "Edad de la mascota (generalmente entre 3 meses y 8 años)",
  "Raza y peso de la mascota",
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Tu mascota es parte de la familia y merece la mejor atención. 
                Protégela con cobertura veterinaria completa para perros y gatos, 
                desde consultas de rutina hasta emergencias.
              </p>
              <a
                href="https://wa.me/573104088621?text=Hola,%20quiero%20cotizar%20un%20seguro%20para%20mi%20mascota"
                target="_blank"
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-accent/20 to-primary/20 p-8 flex items-center justify-center">
                <PawPrint className="h-40 w-40 text-primary/40" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              Para todos los amantes de las mascotas que quieren garantizar 
              la mejor atención médica para sus perros y gatos. Ideal si 
              buscas tranquilidad ante gastos veterinarios inesperados y 
              quieres brindarle a tu mascota cuidado de calidad.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mt-4 text-lg text-primary-foreground/90">
            Cotiza gratis y sin compromiso. Planes desde $25.000 mensuales.
          </p>
