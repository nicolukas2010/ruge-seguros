...
import { Package, Shield, CheckCircle2, ArrowLeft } from "lucide-react"

export const metadata: Metadata = {
  title: "Seguro de Transporte de Mercancía | Ruge Seguros",
  description: "Protege tu carga durante el transporte nacional e internacional contra pérdidas y daños.",
}

const coberturas = [
  "Hurto y daño de mercancia",
  "Falta de entrega",
  "Averia general, comun o gruesa",
  "Lucro cesante",
  "Entre otros",
]
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full bg-accent/10 px-4 py-2 text-accent">
                ...
                <span className="text-sm font-semibold">Seguros de Transporte</span>
              </div>
              <h1 className="mt-6 text-4xl font-extrabold text-primary sm:text-5xl">
                Transporte de Mercancía
              </h1>
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Protege tu carga contra imprevistos durante el transporte. 
                Cobertura nacional e internacional para todo tipo de mercancías, 
                desde materias primas hasta productos terminados.
              </p>
              <a
                href="https://wa.me/573104088621?text=Hola,%20quiero%20cotizar%20un%20seguro%20de%20transporte%20de%20mercancía"
                target="_blank"
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-accent/20 to-primary/20 p-8 flex items-center justify-center">
                <Package className="h-40 w-40 text-primary/40" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              Ideal para empresas importadoras, exportadoras, comercializadoras 
              y cualquier negocio que transporte mercancía por vía terrestre, 
              marítima o aérea. También para transportadores que quieran 
              ofrecer mayor seguridad a sus clientes.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-primary-foreground sm:text-4xl">
            Protege tu mercancía hoy mismo
          </h2>
          <p className="mt-4 text-lg text-primary-foreground/90">
            Cotiza gratis y sin compromiso. Planes para envíos únicos o pólizas anuales.
          </p>
